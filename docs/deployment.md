...
This guide reproduces the secure deployment model used by this repository:

- public SigNoz dashboard through Cloudflare Tunnel
...
`setup.sh` installs Docker, UFW, curl, htop, and openssl on Ubuntu.
